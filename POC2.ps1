...
$imagePaths = @(
    "https://raw.githubusercontent.com/JoseHerrera00/popupscrip/main/image1.png",
    "https://raw.githubusercontent.com/JoseHerrera00/popupscrip/main/image2.png",
    "https://raw.githubusercontent.com/JoseHerrera00/popupscrip/main/Image3.png"
)
$image4Path = "https://raw.githubusercontent.com/JoseHerrera00/popupscrip/main/image5.png"



# Verificar si todas las imágenes existen (para URLs)
...
function Load-Image {
    ...
    try {
        ...
        # Crear MemoryStream correctamente
...
function Show-ImagesSequentially {
    ...
    $imageDisplayTimes = @(
        5,   # Tiempo en segundos para la primera imagen
        5,   # Tiempo en segundos para la segunda imagen
        5    # Tiempo en segundos para la tercera imagen
    )
